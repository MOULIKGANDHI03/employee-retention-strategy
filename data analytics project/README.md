...
This will automatically clean the data, train the models, and generate:
- Several `.png` charts (EDA and Feature Importances).
- A `retention_playbook.md` file summarizing the strategic HR recommendations.
